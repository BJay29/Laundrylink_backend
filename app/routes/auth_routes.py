...
# Updated to use dynamic user_id in the URL path for better testing and organization
...
def update_user_profile(
    ...
    """
    Updates personal details (like address) in the customer_profiles table.
    ...
    if not updated_user:
        # Returns 404 if the user doesn't exist or is an Owner (no customer profile)
        raise HTTPException(
            status_code=404, 
