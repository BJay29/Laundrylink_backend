...
def add_new_machine(
    ...
    """
    return machine_controller.create_machine(db, machine_data, shop_id=current_user.shop_id)
...
def update_machine_config(
    ...
    """
    return machine_controller.update_machine(db, machine_id, update_data, current_user.shop_id)
...
def remove_machine(
    ...
    """
    return machine_controller.delete_machine(db, machine_id, current_user.shop_id)
...
def setup_default_machines(
    ...
    """
    return machine_controller.initialize_shop_machines(db, current_user.shop_id)
...
def reset_all_statuses(
    ...
    """
    return machine_controller.reset_all_machines(db, current_user.shop_id)